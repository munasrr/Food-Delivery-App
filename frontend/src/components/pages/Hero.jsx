...
function Hero() {
  return (
    <Wrapper>
      <section className="hero flex flex-col md:flex-row items-center justify-between md:mt-16 bg-background text-text dark:bg-background-dark dark:text-text-dark">
