            ...
            <nav className="hidden md:flex items-center gap-6 text-gray-700 font-semibold dark:text-text-dark">
              ...
              <Link to="/cart" className="relative">
                <FaShoppingCart
                  ...
                  size={24}
                />
                <span className="absolute -top-2 -right-2 bg-slate-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs">
                  {totalQuantity}
                </span>
              </Link>
              {userInfo ? (
                ...
                <>
                  <Link
                    to="/login"
                    className="bg-primary rounded-full text-white px-6 py-2 bg-primary/90 transition-colors dark:bg-primary-dark dark:bg-primary/90"
                  >
                    Login
                  </Link>
                  <Link
