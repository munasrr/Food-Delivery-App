  ...
  return (
    <div className="container mx-auto p-4 mt-24 bg-background text-text">
      <Wrapper>
        <button
          onClick={() => navigate("/")}
          className="fixed top-4 left-4 mt-24 flex items-center gap-2 bg-primary text-white py-2 px-4 rounded-full shadow-lg bg-primary/90 dark:bg-primary-dark dark:bg-primary/90 focus:outline-none"
        >
        ...
        <h1 className="text-4xl font-bold mb-4 text-center text-primary dark:text-primary-dark">
          Your Order{" "}
          <ThumbsUp className="inline-block w-8 h-8 ml-2 text-red-500" />
        </h1>
